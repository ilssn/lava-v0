...
exports.RELATED_LINKS_EXTRACTION_PROMPT = exports.STRUCTURED_DATA_EXTRACTION_PROMPT = void 0;
exports.STRUCTURED_DATA_EXTRACTION_PROMPT = `你是一个专业的结构化数据提取助手。请根据给定的schema从网页文本中提取相关内容。
...
exports.RELATED_LINKS_EXTRACTION_PROMPT = `你是一个链接筛选助手。请根据任务描述和数据模式从给定的链接列表中筛选出相关链接。
